...
public class ExceptionExample6 {
   ...
   */
   ...
   public static void change(int[] course) {
      ...
      if (debug ==false ) System.out.println("in method change ");

      try {
         course[ILLEGAL_INDEX] = 10;  // this statement generates exception
      }
      catch (ArrayIndexOutOfBoundsException e) {
         System.out.println("Sorry, index " + ILLEGAL_INDEX + " does not exist.");
      }

      if (debug == false) System.out.println("end of method change");
   }
   ...
   public static void main (String[] args) {
      ...
      if (debug == false ) System.out.println("end of main");
   }
   
   // it won't print anything after if debug == false
}