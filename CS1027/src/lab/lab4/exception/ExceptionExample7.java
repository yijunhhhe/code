public class ExceptionExample7 {
   ...
   */
   ...
   public static void change(int[] course) {
      ...
      course[ILLEGAL_INDEX] = 10;   // generate the exception
      
      // it won't continue. once exception generate catch will handle the exception immediately
   ...
   // if debug change to debug = false the print statement won't print anything
}