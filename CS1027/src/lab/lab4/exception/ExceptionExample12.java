...
public class ExceptionExample12 {
   ...
   public static void main (String[] args) throws Exception {
      ...
      */
      ...
      try {
         int value = Integer.parseInt(userTyped);   //  2 try clauses
         System.out.println("Divide by zero " + 5/0);
      }
      catch (NumberFormatException e) {
         System.out.println("Hey, that's not an integer!");  // possible 
      }
      catch (ArithmeticException e) {
         System.out.println("I don't know how to divide by 0.");  // possible 
      }
